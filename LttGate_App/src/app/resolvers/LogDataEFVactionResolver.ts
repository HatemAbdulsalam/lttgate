...
export class LogDataEFVactionResolver implements Resolve<LogDate[]>{
    pageNumber = 1;
    pageSize = 30;
    ...
    resolve(route:ActivatedRouteSnapshot):Observable<LogDate[]>{
        ...
        return this.LogDataVactionService.getLogdataEFvaction(this.pageNumber,this.pageSize).pipe(
          catchError(error => {
